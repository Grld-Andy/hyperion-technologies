  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      >
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:bg-primary-deep focus:text-primary-foreground focus:px-4 focus:py-2 focus:rounded-lg"
        >
