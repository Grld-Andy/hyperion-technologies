    ...
    <>
      <section className="bg-primary-deep py-20 text-primary-foreground">
        <div className="container-hyperion text-center">
          <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gold-soft">Contact</span>
          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <a
                ...
                className="flex items-center gap-3 rounded-xl border border-border p-5 transition-colors hover:border-primary-glow"
              >
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-accent text-primary">
                  <Phone className="h-5 w-5" />
                </span>
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Call Now</p>
                  <p className="font-medium text-primary-deep">{CONTACT.phone}</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-primary-deep">Chat with us</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-primary-deep break-all">{CONTACT.email}</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-primary-deep">Get directions</p>
                </div>
              </a>
            </div>
              ...
              <ul className="mt-3 space-y-1.5 text-sm text-muted-foreground">
                {CONTACT.hours.map((h) => (
                  <li key={h.day} className="flex justify-between">
                    <span>{h.day}</span>
                    <span className="font-medium text-primary-deep">{h.time}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="mt-8">
              <p className="mb-3 flex items-center gap-2 text-sm font-semibold text-primary-deep">
                <MapPin className="h-4 w-4 text-gold" /> Our Location
              </p>
